...
-  **Receipt Recognition**: Upload receipt images (JPG, PNG) and automatically extract expense information
...
-  Automatically extracts:
  - Merchant name, amount, date, expense category
  - Item list, tax, discount information
  - Payment method, merchant address
...
- Supports both Chinese and English receipt recognition
...
- [Google Finance Tracker Project](https://ai.google.dev/competition/projects/finance-tracker?hl=zh-cn)
