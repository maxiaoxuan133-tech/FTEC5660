...
class ReceiptAgent:
    ...
    def process_multiple_receipts_with_query(
        ...
        try:
            ...
            # COMPREHENSIVE PROMPT: Handles various user queries accurately
            prompt = ChatPromptTemplate.from_messages([
                ("system", """You are a precise receipt analysis assistant. Users may ask various questions about their receipts.

CRITICAL - How to Read Receipt Amounts:
- Each receipt shows a FINAL TOTAL at the bottom
- Discounts are shown with a MINUS sign, e.g., '-$20.00', '-$5.50'
...
Example:
  If receipt shows: Total $100, Discounts -$10, -$5, -$5
  Then ORIGINAL before discounts was: $100 + $10 + $5 + $5 = $120
...
6. INDIVIDUAL RECEIPT DETAILS:
   - Read the full receipt and report key info (total, items, etc.)
