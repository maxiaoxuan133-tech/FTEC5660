...
from character.action_modules.evaluate_noc_nor import run_evaluate_noc_nor
...
class Character:
    ...
    def evaluate_noc_nor(self, environment_description, action_history):
        number_of_character, number_of_resource, thought = run_evaluate_noc_nor(self.id_number,
                                                                             self.get_self_description(),
                                                                             environment_description,
                                                                             action_history,
                                                                             engine=self.engine,
                                                                             logger=self.logger)
        return number_of_character, number_of_resource, thought
